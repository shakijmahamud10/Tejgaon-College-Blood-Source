...
<ul class="nav nav-stacked">
	...
	<li><a href="admin_adonor.php"><i class="fa fa-users fa-lg text-success"></i> Regular Donors</a></li>
	<li><a href="admin_ndonor.php"><i class="fa fa-users fa-lg text-danger"></i> Irregular Donors</a></li>
	
	<hr>
	<li><a href="#add" data-toggle="collapse" ><i class="fa fa-cogs fa-lg"></i> More</a></li>
