		    ...
		    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center" style="padding:5px;font-size:16px;font-weight:bold"><span class="fa fa-paper-plane "> </span> Emergency Blood Request</h3>
                    </div>
					...
					<?php
						if(isset($_POST["submit"]))
						{
								...
								{
									$target_file ="request_image/images.png";	
								}
								
								 $sql="INSERT INTO request_blood(NAME,GENDER,BLOOD,BUNIT,HOSP,CITY,PIN,DOC,RDATE,CNAME,EMAIL,CON1,CON2,REASON,PIC,CADDRESS)
								 VALUES('{$_POST["NAME"]}','{$_POST["GENDER"]}','{$_POST["BLOOD"]}','{$_POST["BUNIT"]}','{$_POST["HOSP"]}','{$_POST["CITY"]}','{$_POST["PIN"]}','','{$_POST["RDATE"]}','{$_POST["CNAME"]}','{$_POST["EMAIL"]}','{$_POST["CON1"]}','{$_POST["CON2"]}','{$_POST["REASON"]}','{$target_file}','{$_POST["CADDRESS"]}')";
									if($con->query($sql))
									{
					...
					<form autocomplete="off" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
								<label class="control-label text-primary">Need Bag Of Blood</label>
                                <input type="number" required name="BUNIT" id="BUNIT" class="form-control" placeholder="Insert No Of Bag">
                          </div>
						<div class="form-group">
								<label class="control-label text-primary">Hospital Name &amp; Address</label>
                                <textarea required name="HOSP" id="HOSP" rows="5" style="resize:none;"class="form-control" placeholder="Hospital Name & Full Address"></textarea>
                          </div>
						 <div class="form-group">
								<label class="control-label text-primary">City</label>
                                <input type="text" required name="CITY" id="CITY" class="form-control" placeholder="Insert City 'ex: Dhaka'">
                          </div>
						 
                         <!--  <div class="form-group">
								<label class="control-label text-primary">Postcode</label>
                                <input type="text" required name="PIN" id="PIN" class="form-control" placeholder="Insert Postcode">
                          </div> -->
						...
						<div class="form-group">
							<label class="control-label text-primary">Your Name</label>
							<input type="text" placeholder="Enter your Name" class="form-control input-sm" name="CNAME" id="CNAME">
						</div>
						<div class="form-group">
                    ...
                    <!--	<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="number" placeholder="Contact Number" class="form-control input-sm" name="CON1" id="CON1">
						</div>
							<div class="form-group">
							<label class="control-label text-primary">University/College Name <sub>(If you're a student)</sub></label>
							<input type="text" placeholder="Enter University/College Name" class="form-control input-sm" name="CON2" id="CON2">
						</div>
						<div class="form-group">
						...
						<!--  	<div class="form-group">
							<label class="control-label text-primary" >Don't Upload Photo. Server isn't ready for that</label>
