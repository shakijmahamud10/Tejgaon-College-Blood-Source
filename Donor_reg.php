        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class=" text-primary">
					<i class='fa fa-users'></i> New Donor Registration</h3><hr>
            </div>
        </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
							...
							<input type="date"  placeholder="YYYY/MM/DD" required id="DOB" name="DOB"  class="form-control">
						</div>
						...
						<select id="blood" name="BLOOD" required class="form-control input-sm">	
						  ...
						  <div class="form-group">
                                ...
                                <select name="COUNTRY" id="COUNTRY" required class="form-control input-sm" required>
						  ...
						  <div class="form-group">
                                ...
                                <select name="CITY" id="CITY" required class="form-control input-sm" required>
								...
								<?php
									...
									if($result->num_rows>0)
									{
										while($row=$result->fetch_assoc())
										{
										echo "<option value='{$row['']}'>{$row['CITY_NAME']}	</option>";
										}
									}
						  ...
						  <div class="form-group">
						   ...
						   <div class="form-group">
                                ...
                                <input type="number" required name="CONTACT_1" id="CONTACT_1" class="form-control" placeholder="Contact No">
                          </div>
						   <div class="form-group">
								<label class="control-label text-primary" for="CONTACT_2" >University/College Name <sub>(If you're a student)</sub></label>
                                <input type="text" required name="CONTACT_2" id="CONTACT_2" class="form-control" placeholder="University/College Name">
                          </div>
						  <hr>
						   <div class="form-group">
								<label class="control-label text-primary"><input type="checkbox" id="c1" >&nbsp; Regular Donor</label>
							</div>
							<div id="volu">
						<div class="form-group">
						 ...
						 <div class="form-group">
						 						<input type="text"  name="VOLUNTARY_GROUP" id="VOLUNTARY_GROUP"  class="form-control" placeholder="Your Nick Name" value="">
						 </div>
						<div class="form-group">
							<label class="control-label text-primary"  for="LAST_D_DATE">Last Blood Donoted Date</label>
							<input type="text"  name="LAST_D_DATE" value="YYYY/MM/DD"  id="LAST_D_DATE" placeholder="YYYY/MM/DD" class="form-control input-sm DATES">
						</div>
					</div>
						  <hr>
